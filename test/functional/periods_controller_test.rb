...
class PeriodsControllerTest < ActionController::TestCase
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post :create, period: { end_date: @period.end_date, from_date: @period.from_date, impact: @period.impact, probability: @period.probability }
    end
  ...
  test "should update period" do
    put :update, id: @period, period: { end_date: @period.end_date, from_date: @period.from_date, impact: @period.impact, probability: @period.probability }
    assert_redirected_to period_path(assigns(:period))
  end
