...
class RisksControllerTest < ActionController::TestCase
  ...
  test "should create risk" do
    assert_difference('Risk.count') do
      post :create, risk: { date_from: @risk.date_from, description: @risk.description, location: @risk.location, time_from: @risk.time_from, type: @risk.type }
    end
  ...
  test "should update risk" do
    put :update, id: @risk, risk: { date_from: @risk.date_from, description: @risk.description, location: @risk.location, time_from: @risk.time_from, type: @risk.type }
    assert_redirected_to risk_path(assigns(:risk))
  end
